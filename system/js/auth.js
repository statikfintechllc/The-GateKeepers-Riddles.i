    ...
    try {
        ...
        await (async () => {
            try {
                ...
                // 3) Check for an existing summon marker in comments. Do not post comments — avoid spam.
                try {
...
export async function createRiddleRequestIssue() {
    ...
    try {
        ...
        (async () => {
            ...
            // Do not post comments to avoid spamming issues — assignments and labels are sufficient
        })();
